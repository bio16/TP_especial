...
pos = sfdp_layout(graph , eweight=graph.ep['weight'])   
#pos = fruchterman_reingold_layout(graph, weight=graph.ep['weight'], r=10.)
...
deg_size = prop_to_size(deg)


width = prop_to_size(graph.ep['weight'],ma=.5)
